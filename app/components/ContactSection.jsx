...
const ContactSection = () => {
  return (
    ...
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
        ...
        >
            <a href="https://github.com/Shardul2003" target="_blank" className="w-full sm:w-auto bg-slate-800 hover:border-purple-500 focus:ring-4 focus:outline-none focus:ring-purple-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5">
                <div className="mr-4">
        ...
        className="items-center justify-center space-y-4 sm:flex sm:space-y-0 sm:space-x-4 rtl:space-x-reverse w-64 h-24"
        >
            <a href="https://www.linkedin.com/in/sharduldhongade/" target="_blank" className="w-full sm:w-auto bg-slate-800 hover:border-purple-500 focus:ring-4 focus:outline-none focus:ring-purple-300 text-white rounded-lg inline-flex items-center justify-center px-4 py-2.5">
                <div className="mr-4">
